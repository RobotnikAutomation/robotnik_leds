...
#define ORANGE strip.Color(102, 0, 255)
...
#define ACK_OK 1
#define ACK_ERROR 2
#define ACK_TIMEOUT 5000 // 5 segundos para que salte el ack
  ...
  if (Serial.available() > 0) {
    ...
    switch (Serial.read()) {
      ...
      case 'P':
        ...
        b > 255 ? b = 255 : b = b;
        w > 255 ? w = 255 : w = w;
        strip.setPixelColor(uint16_t(p), strip.Color(g, r, b));
        strip.show();
      ...
      case 'Z':
        ...
        b > 255 ? b = 255 : b = b;
        w > 255 ? w = 255 : w = w;
        colorWipe (strip.Color(g, r, b), p, pend);
        break;
      case 'a':
      case 'A':
        menStand = NONE;
        ...
        b > 255 ? b = 255 : b = b;
        w > 255 ? w = 255 : w = w;
        colorWipe (strip.Color(g, r, b), 0, leds);
        break;
      case 'k':
      case 'K':
        // esto es el ack. meter la actualizacion de los millis aqui si queremos que se actualice solo si recibimos el ack
        break;
      case 'm':
      case 'M':
...
void Mensajes() {
  ...
  else if (estado == BOOOTING) {
    WaitI();
  }
  else if (estado == ACK_ERROR) {
    ErrorI();
  }
}
