...
public:
  LedsPart(TYPE_PART _part, int _led_start, int _led_end, TYPE_LED_MODE _mode = TYPE_LED_MODE::continous,
           TYPE_COLOR _color1 = TYPE_COLOR::white, TYPE_COLOR _color2 = TYPE_COLOR::white,
           TYPE_COLOR _color3 = TYPE_COLOR::white);
  LedsPart(TYPE_PART _part, int _led_start, int _led_end, TYPE_LED_MODE _mode = TYPE_LED_MODE::continous,
           Color _color1 = Color(TYPE_COLOR::white), Color _color2 = Color(TYPE_COLOR::white),
